...
void smithytest() {
	...
	int testvalue = smithyFunc(0, 1, &gamestate);
	...
	else printf("FAIL: hand count for current player incorrect - should be %d, but is %d\n", preHandCount1 + 2, gamestate.handCount[0]);
